...
import { setSortValue , setAscValue } from '../../redux/slices/filterSlice'
	...
	return (
      ...
      <div className={styles.sortLabel}>
        <svg
          ...
          className={`${styles.sortArr} ${ascValue ? styles.noneSort : styles.activeSort}`}
					onClick={() => dispatch(setAscValue())}
          width="10"
          height="6"
          viewBox="0 0 10 6"
          fill="none"
